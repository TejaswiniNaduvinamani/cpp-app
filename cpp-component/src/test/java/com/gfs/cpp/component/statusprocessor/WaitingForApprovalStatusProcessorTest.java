...
public class WaitingForApprovalStatusProcessorTest {

    @InjectMocks
    private WaitingForApprovalStatusProcessor target;
    ...
    @Test
    public void shouldReturnTrueWhenCurrentCppStatusIsHold() throws Exception {
    ...
    public void shouldReturnHoldStatusForToUpdateStatus() throws Exception {
        assertThat(target.getUpdateToStatus(), equalTo(ContractPriceProfileStatus.WAITING_FOR_APPROVAL));
    }

    @Test
    public void shouldReturUpdateUser() throws Exception {
        assertThat(target.getUpdateUserId(), equalTo(WaitingForApprovalStatusProcessor.UPDATE_USER_ID));
    }
